...
> ⚠️ DevDoctor is pre-release. Run via the instructions above. Global npm package publishing coming soon.

### Current Limitations

DevDoctor is an early MVP. It currently focuses on **Node.js, Python, and Docker** workflows. The report supports both English and Chinese.
...
> ⚠️ DevDoctor 是预览版本，通过以上方式使用。npm 全局包即将到来。

### 当前局限

DevDoctor 是早期 MVP。当前重点是 **Node.js、Python 和 Docker** 工作流。报告支持中英文说明。
